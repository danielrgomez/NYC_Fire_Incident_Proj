...
with DAG(
    ...
    def extract_data(**kwargs):
        json_extracted_data = extract_data_via_api(api_url,token,dataset_id,limit_rows,data_source) #Calls the extract_fire_incidents_data from the pull_fire_incidents.py file
